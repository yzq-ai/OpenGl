...
namespace test
{
        ...
        m_TranslationA(glm::vec3(200, 200, 0)), m_TranslationB(glm::vec3(400, 200, 0))
    {
        ...
        m_Texture = std::make_unique<Texture>("res/textures/avater.png");
    }
    ...
    {
        ImGui::SliderFloat3("m_TranslationA", &m_TranslationA.x, 0.0f, 1280.0f);
        ImGui::SliderFloat3("m_TranslationB", &m_TranslationB.x, 0.0f, 1280.0f);
